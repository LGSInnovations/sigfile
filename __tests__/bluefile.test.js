...
describe('keyword_test_file', function() {
    it('should load correctly', function() {
        ...
        fs.readFile("./__tests__/dat/keyword_test_file.tmp", function(err, data) {
            if (err) {
                throw err;
            }
    ...
    it('should read bluefile int data from HTTP', function() {
    ...
    it('should read bluefile ascii Keywords', function() {
        const bfr = new bluefile.BlueFileReader();
    ...
    it('should read all keywords as JSON (default) from HTTP', function() {
    ...
    it('All Keywords as JSON (json) from HTTP', function() {
        const bfr = new bluefile.BlueFileReader({
    ...
    it('All Keywords as JSON (dict)', function() {
        const bfr = new bluefile.BlueFileReader({
    ...
    it('All Keywords as JSON ({})', function() {
        const bfr = new bluefile.BlueFileReader({
            ext_header_type: {}
        });
        bfr.read_http("dat/keyword_test_file.tmp", function(hdr) {
    ...
    it('All Keywords as Array (list)', function() {
        const bfr = new bluefile.BlueFileReader({
    ...
    it('complex float data', function() {
        const bfr = new bluefile.BlueFileReader();
